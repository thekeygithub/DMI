								...
								<c:when test="${not empty listMtsDBdataDetail}">
									<c:forEach items="${listMtsDBdataDetail}" var="pd" varStatus="vs">
										<tr>
											...
											<td class="center">${pd.TERMINOLOGY_TYPE}</td>
											<td class="center">${pd.DOUBT_DIAG}</td>
											<td class="center">${pd.SPECIAL_CHARACTERS}</td>
											<td class="center">${pd.CAN_NOT_STANDARD_TYPE}</td>
											<td class="center">${pd.STAND_STATUS}</td>
										</tr>
									</c:forEach>
								</c:when>
								<c:otherwise>

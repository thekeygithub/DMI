...
<body class="no-skin">
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="mtsDBDataUnstructured/readExcelUnstructured.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
								<div id="zhongxin">
	...
	<script type="text/javascript">
		...
		function save(){
			...
			if($("#excel").val()=="" || document.getElementById("excel").files[0] =='请选择xls格式的数据文件'){
				$("#excel").tips({
					side:3,
		            msg:'请选择文件',
		            bg:'#AE81FF',

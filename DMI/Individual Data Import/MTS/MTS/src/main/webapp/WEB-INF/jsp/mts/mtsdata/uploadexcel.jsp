		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="mtsData/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
								<div id="zhongxin">
								<table style="width:95%;">
									<input type='hidden' name="batchNo" value="${batchNo}"/>
									<tr>
										
										<td align="center" ><h4>批次号：${batchNo}</h4></td>
									</tr>
									<tr>
											<td align="center" >
											<select  name="area" id="area_" style="width:98%;margin-top: 10px;" >

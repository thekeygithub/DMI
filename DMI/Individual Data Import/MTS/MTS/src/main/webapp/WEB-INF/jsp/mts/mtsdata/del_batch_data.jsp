		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								<form action="mtsData/delBatchData.do" name="Form" id="Form" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											<td style="text-align: center;" colspan="10">
												<a class="btn btn-mini btn-primary" onclick="javascript:delBatch();">删除</a>
...
<script type="text/javascript">
	...
	//删除
	function delBatch(){
		bootbox.confirm("确定要删除当前批次数据吗?", function(result) {
			if(result) {
				top.jzts();
				var url = "<%=basePath%>mtsData/delBatchData.do?batchNo="+$("#batchNo_").val();
	...
	function changeClass(v) {  
		   ...
		   jQuery.ajax({  
		        url : '<%=basePath%>mtsData/selClassReloadDict.do',  
		        type : 'post',  
	...
	function changeArea(v) {  
		   ...
		   jQuery.ajax({  
		        url : '<%=basePath%>mtsData/selReloadBatch.do',  
		        type : 'post',  

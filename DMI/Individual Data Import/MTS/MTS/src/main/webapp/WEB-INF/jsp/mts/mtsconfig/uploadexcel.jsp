		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="mtsConfigDR/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
								<div id="zhongxin">
								<table style="width:95%;" >
									...
									<tr>
										<td style="padding-left:2px;">										
										  <select  name="FLAG" id="FLAG"  style="width:150px;" >
											...
											<c:forEach items="${sourceList}" var="DATA_SOURCE">
									...
									<tr>
										<td style="padding-left:2px;">										
										  <select  name="AREACODE" id="AREACODE"  style="width:150px;" >
											<option value="" >选择导入区域</option>									
									...
									<tr>
										<td style="padding-left:2px;">										
										  <select  name="CLASSCODE" id="CLASSCODE"  style="width:150px;" >

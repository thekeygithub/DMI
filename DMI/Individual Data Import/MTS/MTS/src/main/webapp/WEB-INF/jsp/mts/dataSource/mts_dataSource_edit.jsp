		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								<form action="mtsDataSource/${msg}.do" name="mtsDataSourceAddForm" id="mtsDataSourceAddForm" method="post">
									<input type="hidden" name="DATA_SOURCE_ID" id="DATA_SOURCE_ID" value="${pd.DATA_SOURCE_ID}"/>
									<div id="zhongxin" style="padding-top: 13px;">
									<table id="table_report" class="table table-striped table-bordered table-hover">
										<tr>
											<td style="width:100px;text-align: right;padding-top: 13px;">标识:</td>
											<td><input type="text" name="FLAG" id="FLAG" value="${pd.FLAG }" maxlength="32" placeholder="这里输入标识" title="标识" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:100px;text-align: right;padding-top: 13px;">数据来源名称:</td>
...
<script type="text/javascript">
	...
	function save(){		
		var msg = '${msg}';
		var OPERATE = '';
		var DATA_SOURCE_ID = '${pd.DATA_SOURCE_ID}';
		if(msg == 'saveDataSource'){
			OPERATE = 'Add';
		}else if(msg == 'editDataSource'){
			OPERATE = 'Edit';
		}
		...
		var result = 'true';
		$.ajax({
			url : '<%=path%>/mtsDataSource/verifyMtsDataSource.do',  
			async: false,
	        type : 'post',  
	        data : {"FLAG" : obj1.value ,"OPERATE" : OPERATE, "DATA_SOURCE_ID" : DATA_SOURCE_ID },  
	        dataType : 'json',  
		...
		$.ajax({
			...
			async: false,
	        type : 'post',  
	        data : {"DESCRIPTION" : obj.value ,"OPERATE" : OPERATE, "DATA_SOURCE_ID" : DATA_SOURCE_ID },  
	        dataType : 'json',  
	        success : function (data) {  
	        	if(data.result == 'false'){
	        	   $("#DESCRIPTION").tips({

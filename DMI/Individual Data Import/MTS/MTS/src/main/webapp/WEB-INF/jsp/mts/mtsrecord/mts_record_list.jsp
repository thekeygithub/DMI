			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="mtsRecord/listMtsRecord.do" method="post" name="mtsRecordForm" id="mtsRecordForm">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							...
							<!-- 开始循环 -->	
							<c:choose>
								<c:when test="${not empty listMtsRecord}">
									<c:forEach items="${listMtsRecord}" var="mtsRecord" varStatus="vs">
										<tr>
											<td class='center' style="width: 30px;">
												<label><input type='checkbox' name='ids' value="${mtsRecord.RECORD_ID}" class="ace"/><span class="lbl"></span></label>
											</td>
											<td class='center' style="width: 30px;">${vs.index+1}</td>
											<td class="center">${mtsRecord.STATUS}</td>
											<td class="center">${mtsRecord.RESULT}</td>
											<td class="center">${mtsRecord.NLP_RESULT }</td>
											<td class="center">${mtsRecord.VISIT_ID}</td>
											<td class="center">${mtsRecord.VISIT_TYPE}</td>
											
											<td class="center">${mtsRecord.DATA_SOURCE}</td>
											<td class="center">${mtsRecord.BATCH_NUM}</td>
											<td class="center">${mtsRecord.DATA_TYPE}</td>
											<td class="center">${mtsRecord.DATA_CLASS}</td>
											<td class="center">${mtsRecord.NLP_ORDER}</td>
											<td class="center">${mtsRecord.OPERATE_TIME}</td>
											<td class="center">${mtsRecord.PARAMETERS}</td>

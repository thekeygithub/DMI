...
<body class="no-skin">
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="mtsCorpus/readXml.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
								<div id="zhongxin">
								<table style="width:95%;" >
									<tr>
										<td style="padding-top: 20px;"><input type="file" id="xml" name="xml" style="width:50px;" onchange="fileType(this)" /></td>
									</tr>
									<tr>
	...
	<script type="text/javascript">
		...
		//保存
		function save(){
			if($("#xml").val()=="" || document.getElementById("xml").files[0] =='请选择xml格式的文件'){
		...
		function fileType(obj){
			...
			if(fileType != '.xml' && fileType != '.txt'){
		    	...
		    	$("#xml").val('');
		    	document.getElementById("xml").files[0] = '请选择正确格式的文件';
		    }
		}
	</script>

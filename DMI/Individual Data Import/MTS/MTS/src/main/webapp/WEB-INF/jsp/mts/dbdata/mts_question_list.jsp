			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="mtsQuestion/listMtsQuestionForDBData.do" method="post" name="mtsQuestionForm" id="mtsQuestionForm">
						<input type="hidden" name="BATCH_NUM" id="BATCH_NUM" value="${pd.BATCH_NUM}"/>
								...
								<c:when test="${not empty listMtsQuestion}">
									<c:forEach items="${listMtsQuestion}" var="mtsQuestion" varStatus="vs">
										<tr>
											...
											<td class="center">${mtsQuestion.DATA_SOURCE}</td>
											<td class="center">${mtsQuestion.DATA_TYPE}</td>
											<td class="center">${mtsQuestion.DATA_CLASS}</td>
					...
					<table style="width:100%;">
						<tr>
							<td style="vertical-align:top;">
								<a class="btn btn-mini btn-success" onclick="exportTxt(1,'${pd.BATCH_NUM}');">导出问题单</a>
							</td>
							<!-- <td style="vertical-align:top;">
...
//导出excel
function exportTxt(type,BATCH_NUM){
	var keywords = $.trim(jQuery('#keywords').val()); 
	
	window.location.href='<%=basePath%>mtsQuestion/exportTxtForDBData.do?keywords='+keywords+'&type='+type+'&BATCH_NUM='+BATCH_NUM;
}
</script>
</html>

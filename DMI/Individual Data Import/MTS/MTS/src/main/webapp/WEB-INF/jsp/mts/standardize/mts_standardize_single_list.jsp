			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="mtsStandardize/standardizeDataForSinglePage.do" method="post" name="standardizeForm" id="standardizeForm">
						<table style="margin-top:5px;">
							...
							<tr>
								<td colspan="2">
									...
									<span class="input-icon">
										待匹配词:
										<input class="nav-search-input" autocomplete="off" id="toStandWord" style="width:400px;" type="text" name="toStandWord" value="${pd.toStandWord }" placeholder="这里输入待匹配词" />
									</span>
									</div>
								</td>
								<td >
									...
									<span class="input-icon">
										待匹配码:
										<input class="nav-search-input" autocomplete="off" id="toStandCode" style="width:400px;" type="text" name="toStandCode" value="${pd.toStandCode }" placeholder="这里输入待匹配码" />
									</span>
									</div>
								</td>
								<%-- <td colspan="4">
									...
									<c:forEach items="${listStanData}" var="mtsQuestion" varStatus="vs">
										<tr>
											...
											<c:if test="${mtsQuestion.STATUS == 0 }">
												 <td class="center"><span style="color: red">未标化</span></td>
											</c:if>

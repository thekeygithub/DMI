		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="mtsCorpus/saveMtsCorpus.do" id="mtsCorpusAddForm" method="post">
								<input type='hidden' id="origContent_" name="origContent" value="" /> 
								<input type='hidden' id="jsonContent_" name="jsonContent" /> 
								<input type='hidden' id="fileName_" name="fileName" value="${fileName}" />
								<div id="zhongxin" style="padding-top: 13px;">
									<div id="contentDiv" contentEditable="false" style="height:500px;overflow-y:scroll;border: 1px solid;">
									</div>
									<div>
	...
	function save() {
		...
		$("#tab tr").each(
				function(i) {
					...
					//保存编辑区内容
					//实体名称
					var entityName = $(this).find("td[id^='entity']")
							.text();

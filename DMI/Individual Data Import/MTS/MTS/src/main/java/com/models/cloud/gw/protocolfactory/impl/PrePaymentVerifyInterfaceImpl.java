 ...
 */
@Service("prePaymentVerifyInterfaceImpl")
public class PrePaymentVerifyInterfaceImpl implements DoServiceInterface {

    private static final Logger logger = Logger.getLogger(PrePaymentVerifyInterfaceImpl.class);
    ...
    public Map<String, Object> doService(Map<String, Object> receiveMap) {
        ...
        try {
            ...
            resultMap = tdOrderServiceGWImpl.prePaymentVerify(inputMap);
        } catch (Exception e) {

...
import com.pay.cloud.gw.protocolfactory.impl.BankCardNoTypeInterfaceImpl;
 ...
 *
 */
@Service("queryCardTypeServiceImpl")
public class QueryCardTypeServiceImpl implements DoPageService {

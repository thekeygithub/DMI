 ...
 */
@Service("verifyMessageToNextPageImpl")
public class VerifyMessageToNextPageImpl implements DoPageService{
	private Logger logger = Logger.getLogger(VerifyMessageToNextPageImpl.class);
	...
	public Map<String, Object> returnDataByMap(Map<String, Object> receiveMap, HttpServletRequest request) {
		...
		if(!returnMap.get("resultCode").equals(Hint.SYS_SUCCESS.getCodeString())){
			return returnMap;
		}

...
import com.pay.cloud.gw.protocolfactory.impl.RegisterImpl;
 ...
 * 
 * @Description: 用户注册
 * @ClassName: RegistPageImpl 
 * @author: zhengping.hu
 * @date: 2016年5月19日 下午4:40:58
 */
@Service("registPageImpl")
public class RegistPageImpl implements DoPageService{

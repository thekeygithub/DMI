...
import com.pay.cloud.gw.protocolfactory.impl.PrePaymentVerifyInterfaceImpl;
 ...
 *
 */
@Service("newCardPrePayOrderServiceImpl")
public class NewCardPrePayOrderServiceImpl implements DoPageService {

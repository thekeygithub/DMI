...
import com.pay.cloud.gw.protocolfactory.impl.RealNameAuthInterfaceImpl;
 ...
 *
 */
@Service("toSMRZServiceImpl")
public class ToSMRZServiceImpl implements DoPageService{

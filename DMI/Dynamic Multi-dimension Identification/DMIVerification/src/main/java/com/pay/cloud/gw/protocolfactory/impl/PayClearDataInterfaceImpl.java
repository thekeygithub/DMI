...
@Service("payClearDataInterfaceImpl")
public class PayClearDataInterfaceImpl  implements DoServiceInterface  {
	...
	public Map<String, Object> doService(Map<String, Object> receiveMap) {
		...
		try{
			Map<String, Object> map = SupplierTradeServiceGW.accountPayClearData(receiveMap);
			return map;
		}catch(Exception ex){
			ex.printStackTrace();

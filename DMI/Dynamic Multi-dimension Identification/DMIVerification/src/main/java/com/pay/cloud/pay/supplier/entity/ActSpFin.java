...
public class ActSpFin {
    ...
    private Long oldVerNum;

    private Long verNum;

    public Long getOldVerNum() {
        return oldVerNum;
    }

    public void setOldVerNum(Long oldVerNum) {
        this.oldVerNum = oldVerNum;
    }
    ...
    public BigDecimal getInTravel() {
        return inTravel;
    }

    public void setInTravel(BigDecimal inTravel) {

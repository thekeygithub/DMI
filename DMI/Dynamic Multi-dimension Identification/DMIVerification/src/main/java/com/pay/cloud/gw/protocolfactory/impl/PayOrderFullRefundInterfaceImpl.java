 ...
 */
@Service("payOrderFullRefundInterfaceImpl")
public class PayOrderFullRefundInterfaceImpl implements DoServiceInterface {
    
	//日志处理
    private static final Logger logger = Logger.getLogger(PayOrderFullRefundInterfaceImpl.class);
    ...
    public Map<String, Object> doService(Map<String, Object> receiveMap){
        ...
        try {
            //生成订单，后续又任务列表处理
        	resultMap = tdOrderRefundServiceGW.prePayOrderRefundMix(receiveMap);
        } catch (Exception e) {

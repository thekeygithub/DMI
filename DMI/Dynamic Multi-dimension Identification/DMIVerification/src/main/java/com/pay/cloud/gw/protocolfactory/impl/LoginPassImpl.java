 ...
 */
@Service("loginPassImpl")
public class LoginPassImpl implements DoServiceInterface {
	
	private static final Logger logger = Logger.getLogger(LoginPassImpl.class);
...
//		}
		try {
			return payUserServiceGWImpl.restLoginPass(receiveMap);
		} catch (Exception e) {

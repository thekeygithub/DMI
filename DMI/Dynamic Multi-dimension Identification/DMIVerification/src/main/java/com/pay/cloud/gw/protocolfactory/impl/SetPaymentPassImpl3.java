...
/**
 * 
 * @Description: 设置支付密码(已绑卡)
 * @ClassName: SetPaymentPassImpl3 
 * @author: zhengping.hu
 * @date: 2016年4月8日 下午4:00:40
 */
@Service("setPaymentPassImpl3")
public class SetPaymentPassImpl3 implements DoServiceInterface {
	
	private static final Logger logger = Logger.getLogger(SetPaymentPassImpl3.class);
...
//		}
		try {
			return payUserServiceGWImpl.setPaymentPass3(receiveMap);
		} catch (Exception e) {

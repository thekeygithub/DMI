...
import com.pay.cloud.gw.protocolfactory.impl.PrePaymentOrderInterfaceImpl;
 ...
 *
 */
@Service("verifyPWDAndPrePayServiceImpl")
public class VerifyPWDAndPrePayServiceImpl implements DoPageService {
...
//		
		...
		prePayMap.put("payToken", sessionOrderMap.get("payToken"));

...
public class ReDetailRecordController extends BaseController {
	...
	@RequestMapping(value = "/reDetailList")
	@Rights(code = "record/reDetailList")
	public ModelAndView reDetailList(Page page) throws Exception {
		...
		mv.setViewName("pay/record/returnDetail/show_reDetail_list");
		mv.addObject("varList", varList);
		mv.addObject("pd", pd);
		return mv;
	}
	
	@RequestMapping(value = "/reTotalSituation4")
	@Rights(code = "record/reTotalSituation4")
	public ModelAndView reTotalSituation4() throws Exception {
		ModelAndView mv = this.getModelAndView();
		PageData pd = this.getPageData();
		pd.put("DATA_TYPE", "2");
		PageData varModel = precordService.findReturnById(pd);
		mv.setViewName("pay/record/returnDetail/show_situation_list4");
	...
	@RequestMapping(value = "/reDetailExcel")
	@Rights(code = "record/reDetailExcel")
	public ModelAndView reDetailExcel() {
		logBefore(logger, Jurisdiction.getUsername()+"导出退费明细对账数据");
		ModelAndView mv = this.getModelAndView();
		PageData pd = this.getPageData();
		pd = this.getPD(pd);
		pd.put("DATA_TYPE", "2");//退费明细对账

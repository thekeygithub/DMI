				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="interInfo/overDetail.do" name="interForm" id="interForm" method="post">
							...
							<div id="zhongxin" style="padding-top: 13px;">
								<table width="100%" style="border: 1px solid #dddddd; padding-bottom: 10px; margin-bottom:10px;">
									<tr height="30">
										...
										<td style="border-left:1px solid;border-left-color:#dddddd;" width="14%" class='center' bgcolor="#F0F0F0">
											<a href="javascript:void(0);" style="text-decoration:none" onclick="queryData('overDetail');">
												<font size="2" color="#7B7B7B"><b>超限明细信息</b></font>
											</a>
										</td>
								...
								<table id="simple-table" width="100%" class="table table-striped table-bordered table-hover" style="margin-top:10px;">
									<thead>
										<tr>
											<th width="9%" class="center">序号</th>
											<th width="13%" class="center">药品诊疗类型</th>
											<th width="13%" class="center">医院项目编码</th>
											<th width="13%" class="center">超限数量</th>
											<th width="13%" class="center">超限自费金额</th>
											<th width="13%" class="center">合计自费金额</th>
											<th width="13%" class="center">超限原因代码</th>
											<th width="13%" class="center">超限原因说明</th>
										</tr>
									</thead>
									...
									<!-- 开始循环 -->	
										<c:choose>
											<c:when test="${not empty varList}">
												<c:forEach items="${varList}" var="overList" varStatus="vs">
													<tr>
														<td width="9%" class='center'>${vs.index+1}</td>
														<td width="13%" class="center">${overList.type_name}</td>
														<td width="13%" class="center">${overList.hosp_name}</td>
														<td width="13%" class="center">${overList.num}</td>
														<td width="13%" class="center"><fmt:formatNumber type="number" value="${overList.self_fee}" pattern="0.00" maxFractionDigits="2"/></td>
														<td width="13%" class="center"><fmt:formatNumber type="number" value="${overList.total_fee}" pattern="0.00" maxFractionDigits="2"/></td>
														<td width="13%" class="center">${overList.rea_code_name}</td>
														<td width="13%" class="center">${overList.rea_desc}</td>
													</tr>
												</c:forEach>
											</c:when>

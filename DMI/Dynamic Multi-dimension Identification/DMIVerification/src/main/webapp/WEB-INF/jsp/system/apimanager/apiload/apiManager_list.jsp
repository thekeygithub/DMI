			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<!-- 检索  -->
						<form action="api/apiload.do" method="post" name="interfaceForm" id="interfaceForm">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
							<thead>
								<tr>
									<th colspan="5" class="center">API用户列表</th>
								</tr>
								<tr>
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
 	...
 	<script type="text/javascript">
		...
		function addload(userName){
			bootbox.confirm("加载数据", function(result) {
				if(result) {
					var url = "<%=basePath%>api/addload.do?USERNAME="+userName;
					$.get(url,function(data){
						window.parent.location = "<%=basePath%>api/load.do";
					});
				}
			});     
		}

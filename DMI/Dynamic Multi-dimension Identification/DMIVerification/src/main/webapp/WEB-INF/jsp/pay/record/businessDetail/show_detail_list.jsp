			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="record/detailList.do" method="post" name="form1" id="form1">
							...
							<table style="margin-top:5px;">
								<tr>
									...
									<td style="vertical-align:top;padding-left:5px;">
										<ts:rights code="record/exporData">
...
<script type="text/javascript">
	...
	function exporData(){
		form1.action = "<%=basePath%>record/exporData.do";
		form1.submit();
		form1.action = "<%=basePath%>record/detailList.do";
	}

				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="interInfo/feeDetail.do" name="interForm" id="interForm" method="post">
								...
								<table width="100%" style="border: 1px solid #dddddd; padding-bottom: 10px; margin-bottom:10px;">
									<tr height="30">
										...
										<td style="border-left:1px solid;border-left-color:#dddddd;" width="14%" class='center' bgcolor="#F0F0F0">
											<a href="javascript:void(0);" style="text-decoration:none" onclick="queryData('feeDetail');">
												<font size="2" color="#7B7B7B"><b>费用汇总信息</b></font>
											</a>
										</td>
								...
								<table id="simple-table" width="100%" class="table table-striped table-bordered table-hover" style="margin-top:10px;">
									<thead>
										<tr>
											...
											<th width="19%" class="center">发票归类</th>
											<th width="19%" class="center">归类名称</th>
											<th width="19%" class="center">总费用</th>
											<th width="19%" class="center">自费费用</th>
											<th width="19%" class="center">自负费用</th>
										</tr>
									</thead>
									...
									<!-- 开始循环 -->	
										<c:choose>
											<c:when test="${not empty varList}">
												<c:forEach items="${varList}" var="feeList" varStatus="vs">
													<tr>
														<td width="5%" class='center'>${vs.index+1}</td>
														<td width="19%" class="center">${feeList.sort}</td>
														<td width="19%" class="center">${feeList.name}</td>
														<td width="19%" class="center"><fmt:formatNumber type="number" value="${feeList.total_fee}" pattern="0.00" maxFractionDigits="2"/></td>
														<td width="19%" class="center"><fmt:formatNumber type="number" value="${feeList.self_fee}" pattern="0.00" maxFractionDigits="2"/></td>
														<td width="19%" class="center"><fmt:formatNumber type="number" value="${feeList.neg_fee}" pattern="0.00" maxFractionDigits="2"/></td>
													</tr>
												</c:forEach>
											</c:when>

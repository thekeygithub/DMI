...
public final class CryptoUtils {
	 ...
	 */
	public final static byte[] hmacSha1(String input, byte[] keyBytes) {
		try {
	 ...
	 */
	public final static String hmacSha1ToHex(String input, byte[] keyBytes) {
	 ...
	 * @see #hmacSha1(String, byte[])
	 */
	public final static String hmacSha1ToBase64(String input, byte[] keyBytes) {
		byte[] macResult = hmacSha1(input, keyBytes);
	 ...
	 * @see #hmacSha1(String, byte[])
	 */
	public final static String hmacSha1ToBase64UrlSafe(String input, byte[] keyBytes) {
		byte[] macResult = hmacSha1(input, keyBytes);
	 ...
	 * @param keyBytes 密钥
	 */
	public final static boolean isHexMacValid(String hexMac, String input, byte[] keyBytes) {
	 ...
	 * @param keyBytes 密钥
	 */
	public final static boolean isBase64MacValid(String base64Mac, String input, byte[] keyBytes) {
	 ...
	 */
	public final static byte[] generateMacSha1Key() {
		try {
	 ...
	 */
	public final static String generateMacSha1HexKey() {
	 ...
	 */
	public final static String desEncryptToHex(String input, byte[] keyBytes) {
	 ...
	 * @param keyBytes 符合DES要求的密钥
	 */
	public final static String desEncryptToBase64(String input, byte[] keyBytes) {
		byte[] encryptResult = des(input.getBytes(), keyBytes, Cipher.ENCRYPT_MODE);
	 ...
	 * @param keyBytes 符合DES要求的密钥
	 */
	public final static String desDecryptFromHex(String input, byte[] keyBytes) {
	 ...
	 * @param keyBytes 符合DES要求的密钥
	 */
	public final static String desDecryptFromBase64(String input, byte[] keyBytes) {
	 ...
	 */
	public final static byte[] generateDesKey() {
		try {
	 ...
	 */
	public final static String generateDesHexKey() {
	 ...
	 */
	public final static String aesEncryptToHex(String input, byte[] keyBytes) {
	 ...
	 * @param keyBytes 符合AES要求的密钥
	 */
	public final static String aesEncryptToBase64(String input, byte[] keyBytes) {
		byte[] encryptResult = aes(input.getBytes(), keyBytes, Cipher.ENCRYPT_MODE);
		return EncodeUtils.base64Encode(encryptResult);
	}
	 ...
	 * @param keyBytes 符合AES要求的密钥
	 */
	public final static String aesDecryptFromHex(String input, byte[] keyBytes) {
	 ...
	 * @param keyBytes 符合AES要求的密钥
	 */
	public final static String aesDecryptFromBase64(String input, byte[] keyBytes) {
	 ...
	 */
	public final static byte[] generateAesKey() {
		try {
	 ...
	 * @see #generateMacSha1Key()
	 */
	public final static String generateAesHexKey() {

...
import com.models.cloud.pay.supplier.dao.ActSpBankMapper;
import com.models.cloud.pay.supplier.dao.ActSpFinMapper;
import com.models.cloud.pay.supplier.entity.ActSpBank;
import com.models.cloud.pay.supplier.entity.ActSpFin;
import com.models.cloud.pay.trade.dao.TdActRecMapper;
...
import com.models.cloud.pay.trade.service.SupplierTradeService;
...
public class SupplierTradeServiceImpl implements SupplierTradeService {
	...
	private void saveTdOrder(Map<String, Object> receiveMap, Long tdId,
		...
		// 交易日期 TD_DATE
		tdOrder.setTdDate(com.models.cloud.util.DateUtils.dateToString(
				crtTime, "yyyyMMdd"));

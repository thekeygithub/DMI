...
public class BaseApiCallable implements Callable<Object> {
	 ...
	 * @param endDate 终止日期
	 */
	public BaseApiCallable(IBaseApi baseApi,String methodName,String idcard,String username,String ss_num, int year, int month) {
	...
	public TheKeyResultEntity call() throws Exception {
		...
		map.put("parm4", getMonthLastDay(year, month));// 终止日期

 ...
 * @author qingsong.li
 */
public class ReadH5PageXmlUtil {

    private final static String h5pagePath = "h5page.xml";
    private static final Logger logger = Logger.getLogger(ReadH5PageXmlUtil.class);
    ...
    private static Map<String, Map<String, String>> readH5PageXml() {
        ...
        try {
            String path = ReadH5PageXmlUtil.class.getClassLoader().getResource("").toURI().getPath();

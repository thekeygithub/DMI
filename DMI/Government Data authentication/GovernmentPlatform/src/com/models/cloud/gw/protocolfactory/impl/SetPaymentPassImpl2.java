...
/**
 * 
 * @Description: 设置支付密码(未绑卡)
 * @ClassName: SetPaymentPassImpl2 
 * @author: zhengping.hu
 * @date: 2016年4月8日 下午4:00:40
 */
@Service("setPaymentPassImpl2")
public class SetPaymentPassImpl2 implements DoServiceInterface {
	
	private static final Logger logger = Logger.getLogger(SetPaymentPassImpl2.class);
...
//		}
		try {
			return payUserServiceGWImpl.setPaymentPass2(receiveMap);
		} catch (Exception e) {

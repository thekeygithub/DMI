package com.ts.controller.fhdb.timingbackup;
...
import com.ts.util.QuartzManager;
...
public class TimingBackUpController extends BaseController {
	...
	@Rights(code="timingbackup/delete")
	...
	@Rights(code="timingbackup/goAdd")
	...
	@Rights(code="timingbackup/goEdit")
	...
	@Rights(code="timingbackup/deleteAll")
	@ResponseBody
	...
	@Rights(code="timingbackup/changeStatus")
	@ResponseBody
	...
	@Rights(code="timingbackup/excel")

...
public class AppuserService implements AppuserManager{
	 ...
	 * @throws Exception
	 */
	public void editIpAndTime(PageData pd)throws Exception{
		dao.update("AppuserMapper.editIpAndTime", pd);
	}
	...
	@Override
	public List<PageData> findByVerifyKey() throws Exception {
		return (List<PageData>)dao.findForList("AppuserMapper.findByVerifyKey");
	}
	
	@Override
	public List<PageData> findByVerifyKeySearch(PageData pd) throws Exception {
		return (List<PageData>)dao.findForList("AppuserMapper.findByVerifyKeySearch", pd);
	}
	
	@SuppressWarnings("unchecked")
	@Override
	public List<PageData> findForPay() throws Exception {
		return (List<PageData>)dao.findForList("AppuserMapper.findForPay");
	}
